...
export default function LocationLink(props) {
    return (
        <div className="flex flex-col items-center">
            ...
            <button className="bg-peach text-white uppercase font-medium tracking-[0.0625rem] rounded-lg p-4 cursor-pointer hover:bg-light-peach transition-all duration-200 ease-in-out">
                See Location
            </button>
        </div>
    )
