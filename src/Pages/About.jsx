...
export default function About() {
    return (
        <section className="max-w-[74.45rem] mx-auto">
            <div className=" bg-peach text-white pb-20 bg-[url('/about/mobile/bg-pattern-hero-about-mobile.svg')] bg-[right_bottom_-27rem] bg-no-repeat md:mx-10 md:rounded-2xl md:bg-[url('/about/desktop/bg-pattern-hero-about-desktop.svg')] md:bg-left lg:flex lg:flex-row-reverse lg:h-[30rem] lg:items-center lg:pb-0 lg:justify-between">
                <picture>
